...
import com.inventive.hack.halotesting.halo.view.adapter.CampaignAdapter;
...
public class CampaignFragment extends BaseFragment
    implements CampaignView, SwipeRefreshLayout.OnRefreshListener {

  @BindView(R.id.progress_loading) ProgressBar mProgressLoading;
  @BindView(R.id.swipe_refresh) SwipeRefreshLayout mSwipeRefresh;
  @BindView(R.id.list_campaign) RecyclerView mListCampaign;
  ...
  private void initializeAdapter() {
    if (mAdapter == null) mAdapter = new CampaignAdapter(getContext(), mPresenter);
  }

  private void initializeList() {
    mListCampaign.setLayoutManager(new LinearLayoutManager(getContext()));
    mListCampaign.setAdapter(mAdapter);
  }
  ...
  @Override public void showCampaign(List<CampaignViewModel> viewModels) {
    mAdapter.setAll(viewModels);
  }

  @Override public void showDetailCampaign(CampaignViewModel campaignViewModel) {
    startActivity(CampaignDetailActivity.provideIntent(getContext(), campaignViewModel));
  }
